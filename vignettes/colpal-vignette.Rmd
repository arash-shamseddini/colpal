...
In Figure \@ref(fig:ggplot-ex-2) and Figure \@ref(fig:ggplot-ex-3) two examples are demonstrated for `edi_scale_col`.
...
In Figure \@ref(fig:ggplot-ex-4) and Figure \@ref(fig:ggplot-ex-5) two examples are demonstrated for `edi_scale_fill`.
